    ...
    <CenteredLayout style={{ maxWidth: 600 }}>
      ...
      <Box
        ...
        style={{
          ...
          borderColor: theme.custom.colors.warning.light,
      ...
      >
        ...
        <Flex vertical justify="center" align="center" gap={theme.custom.spacing.xsmall}>
          <Title level={2} style={{ color: theme.custom.colors.warning.default }}>
            {t('subscriptionGuard.trialEnded')}
          </Title>
          <Paragraph type="secondary">
            {t('subscriptionGuard.trialEndedDescription')}
          </Paragraph>
        </Flex>
