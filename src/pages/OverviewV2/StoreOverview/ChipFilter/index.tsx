...
interface ChipFilterProps {
  options: StoreOverviewFilter[];
  values: StoreOverviewFilter[];
  onChange: (value: StoreOverviewFilter[]) => void;
  onFilterClick?: () => void;
  style?: React.CSSProperties;
}

export const ChipFilter: React.FC<ChipFilterProps> = ({ options, values = [] as StoreOverviewFilter[], onChange, onFilterClick, style }) => {
