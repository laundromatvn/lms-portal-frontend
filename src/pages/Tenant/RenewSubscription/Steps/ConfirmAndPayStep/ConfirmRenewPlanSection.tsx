...
export const ConfirmRenewPlanSection: React.FC<Props> = ({ subscriptionPlan, previewSubscriptionInvoiceResult, onConfirmed }) => {
    ...
    <BaseDetailSection style={{ padding: 0 }}>
      ...
      >
        ...
        <Flex vertical gap={theme.custom.spacing.small} style={{ width: '100%' }}>
          <Typography.Text>
            <Trans
              i18nKey="subscription.doYouWantToRenewYourSubscriptionPlan"
