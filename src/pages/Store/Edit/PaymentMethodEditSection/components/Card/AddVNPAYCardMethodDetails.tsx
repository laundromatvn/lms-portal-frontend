...
export const AddVNPAYCardMethodDetails: React.FC = () => {
  ...
  return (
    <>
      ...
      <Form.Item name="init_secret_key" label={t('common.initSecretKey')}
        rules={[
      ...
      <Form.Item name="query_secret_key" label={t('common.querySecretKey')}
        rules={[
      ...
      <Form.Item name="ipnv3_secret_key" label={t('common.ipnv3SecretKey')}
        rules={[
